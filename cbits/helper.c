...
int get_start_line (yaml_event_t *e)
{
	return e->start_mark.line;
}

int get_end_line (yaml_event_t *e)
{
	return e->end_mark.line;
}

int get_start_column (yaml_event_t *e)
{
	return e->start_mark.column;
}

int get_end_column (yaml_event_t *e)
{
	return e->end_mark.column;
}
